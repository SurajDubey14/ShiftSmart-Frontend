...
const TopHeader = () => {
  return (
    <div class="bg-[var(--color-primary)] hidden text-sm text-center text-white lg:flex items-center flex-col lg:flex-row lg:border-b-2 lg:border-white justify-between lg:px-44 py-2 shadow-2xl">
      ...
      <div class="flex items-center flex-col lg:flex-row text-center justify-center gap-y-2 lg:gap-x-4 py-4 lg:p-0">
        <div className="mob">
          ...
          >
            {" "}
            <Phone size={16} strokeWidth={1.25} /> +91-9310745399
          </a>
        </div>
